...
------------------------------------------------------------------
### This repo consists of a RAG (Retrieval Augmented Generation) on a text-based details about the products image to optimize the output of existing LLMs (large Language Models).
...
### It outputs (NEED TO ADD ABOUT THE EXACT OUTPUT)
------------------------------------------------------------------
### Steps to run:-
`command 1`
