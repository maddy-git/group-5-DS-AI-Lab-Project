...
# Directories
product_dir = os.getcwd() + '/data/cloth_test_set.csv'
customers_dir = os.getcwd() + '/data/customers_first_3000.csv'
transactions_dir = os.getcwd() + '/data/transactions_first_3000_customers.csv'
product_embedding_dir = os.getcwd() + '/data/cloth_test_set.parquet'
images_dir = os.getcwd() + '/data/images/h-and-m-personalized-fashion-recommendations/images'
...
product_faiss_index_dir = os.getcwd() + '/data/product_index_on_text_only.faiss'
product_faiss_dir = os.getcwd() + '/data/products_with_meta.parquet'
